  ...
  if (gameState.phase === GamePhase.PLAYING && gameState.currentTurn) {
      ...
      return (
          <div className="flex flex-col items-center justify-center min-h-[70vh] space-y-8 w-full max-w-md mx-auto">
              ...
              {/* Status Header */}
              <div className="bg-dark-800 px-6 py-2 rounded-full border border-white/10 text-sm font-bold flex items-center gap-2">
                              ...
                              <>
                                ...
                                <div className="text-center w-full">
                                     ...
                                     {!turn.isActive && turn.timeLeft > 0 && (
                                         <Button onClick={() => sendAction('START_TIMER')} className="text-xl w-full max-w-xs animate-bounce-small">
                                             Start Timer
                                         </Button>
                                     )}
                               ...
                               <div className="w-full flex flex-col items-center gap-6">
                                   ...
                                   <Button onClick={() => sendAction('REVEAL_CLUE')} className="text-xl w-full max-w-xs">
                                       Reveal Clue
                                   </Button>
                               </div>
                          )}
